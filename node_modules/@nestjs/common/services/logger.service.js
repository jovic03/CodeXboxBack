...
let Logger = Logger_1 = class Logger {
    ...
    debug(message, ...optionalParams) {
        ...
        optionalParams = this.context
            ? optionalParams.concat(this.context)
            : optionalParams;
        (_a = this.localInstance) === null || _a === void 0 ? void 0 : _a.debug(message, ...optionalParams);
    }
    verbose(message, ...optionalParams) {
        ...
        optionalParams = this.context
            ? optionalParams.concat(this.context)
            : optionalParams;
        (_a = this.localInstance) === null || _a === void 0 ? void 0 : _a.verbose(message, ...optionalParams);
    }
    ...
    static debug(message, ...optionalParams) {
        var _a;
        (_a = this.staticInstanceRef) === null || _a === void 0 ? void 0 : _a.debug(message, ...optionalParams);
    }
    static verbose(message, ...optionalParams) {
        var _a;
        (_a = this.staticInstanceRef) === null || _a === void 0 ? void 0 : _a.verbose(message, ...optionalParams);
    }
    /**
    ...
    static overrideLogger(logger) {
        ...
        this.staticInstanceRef = shared_utils_1.isObject(logger)
            ? logger
            : undefined;
    }
