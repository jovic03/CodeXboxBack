...
class Module {
    ...
    addCustomValue(provider, collection) {
        ...
        collection.set(providerToken, new instance_wrapper_1.InstanceWrapper({
            token: providerToken,
            name: ((_a = providerToken) === null || _a === void 0 ? void 0 : _a.name) || providerToken,
            metatype: null,
            instance: value,
            isResolved: true,
    ...
    validateExportedProvider(token) {
        ...
        const imports = iterare_1.iterate(this._imports.values())
            .filter(item => !!item)
        ...
        if (!imports.includes(token)) {
            ...
            const providerName = shared_utils_1.isFunction(token) ? token.name : token;
    ...
    createModuleReferenceType() {
        ...
        return class extends module_ref_1.ModuleRef {
            ...
            resolve(typeOrToken, contextId = context_id_factory_1.createContextId(), options = { strict: true }) {
