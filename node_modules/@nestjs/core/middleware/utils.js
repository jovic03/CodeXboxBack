...
exports.isRouteExcluded = exports.assignToken = exports.isMiddlewareClass = exports.mapToClass = exports.filterMiddleware = void 0;
...
function isRouteExcluded(req, excludedRoutes, httpAdapter) {
    ...
    const isExcluded = excludedRoutes.some(({ method, regex }) => {
        if (common_1.RequestMethod.ALL === method ||
            common_1.RequestMethod[method] === reqMethod ||
            method === -1) {
